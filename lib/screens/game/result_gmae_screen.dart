...
class _ResultGamaState extends State<ResultGama> {
  ...
  getDataInGame() async {
    ...
    try {
      ...
      setState(() {});
      await dbRef.child(Provider.of<Notifier>(context, listen: false).referral)
          .once()
          .then((value) {
  ...
  void initState() {
    Future.delayed(
      Duration(microseconds: 100), () {getDataInGame();},
    );
    super.initState();
  }
              ...
              child: FutureBuilder(
                ...
                builder: (BuildContext context, AsyncSnapshot snapShot) {
                  if (snapShot.hasData &&
                    ...
                    score=data['score'];
                    name=data['name'];
                    int rate = data['restaurant']['restaurantRate'];
                    return Center(
