...
class _ResultGamaState extends State<ResultGama> {
  ...
  int score;
  String name;
  String challengeName, city, date, time,referralCode,restaurantName,restaurantImg,restaurantAddress,winner;
              ...
              builder: (BuildContext context, AsyncSnapshot snapShot) {
                if (snapShot.hasData &&
                  ...
                  if(data['winner']!=null){
                    ...
                    Provider.of<Notifier>(context, listen: false).changeWinnerRestaurantScore(data['winner']['restaurantScore']);
                    Provider.of<Notifier>(context, listen: false).changeWinnerReview(data['winner']['restaurantReview']);
                  }else{
                    winner=data['winner'];
                                        ...
                                        Container(
                                          ...
                                          decoration: BoxDecoration(
                                            image: DecorationImage(
                                                image: NetworkImage("$restaurantImg")),
                                          ),
                                        ),
                                        SizedBox(
                                                width: 8,
